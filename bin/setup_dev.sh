...
oc set probe dc/tasks --readiness --get-url=http://:8080/ --initial-delay-seconds=90 --timeout-seconds=2 -n ${GUID}-tasks-dev
oc set probe dc/tasks --liveness --get-url=http://:8080/ --initial-delay-seconds=90 --timeout-seconds=2 -n ${GUID}-tasks-dev
